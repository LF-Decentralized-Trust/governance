...
- Fabric v3.1.3 - October 18, 2025: Urgent release which fixes a bug introduced in v3.1.2 that causes a docker mount issue when building the orderer Dockerfile. Does not affect binary builds or self provides Dockerfiles.
