...
<img width="598" height="366" alt="image" src="https://github.com/user-attachments/assets/3f9c033b-2903-4320-988e-47365de0b80a" />
<img width="598" height="366" alt="image" src="https://github.com/user-attachments/assets/ef6e8996-c72b-4f6b-b9c2-f3944f91ac87" />

BlockyDev maintainers joined the community to help contribute to [hiero-cli](https://github.com/hiero-ledger/hiero-cli/) which can be reflected in the [repo's GitHub Insights](https://github.com/hiero-ledger/hiero-cli/graphs/contributors?all=1) page. The Hiero CLI Tool is a powerful and intuitive command-line interface designed to streamline your interactions with the Hiero network.

DSR maintainers joined as part of the Hiero [heka-identity-platform](https://github.com/hiero-ledger/heka-identity-platform) which provides a ready to use decentralized identity solution and has featured several presentations on it's initiatives including [Meetup Workshops](https://www.youtube.com/watch?v=2Hk8snmASnc&t=2s), [blog posts](https://www.lfdecentralizedtrust.org/blog/hiero-adds-heka-identity-platform-as-subproject-to-advance-open-source-decentralized-identity) as well as in person demo showcases at events like [WomenWhoCode 2026](https://womenwhocode.com/) and [Hiero Community Day Berlin 2026](https://hiero.org/blog/hiero-community-day-launched-2026).

Hahsgraph Online became part of Hiero through their [Hiero Consensus Specifications](https://github.com/hiero-ledger/hiero-consensus-specifications) sub project which provides open, versioned specifications for interoperable data formats and protocol patterns layered on top of the Hiero Consensus Service (and similar consensus/message transports). These maintainers have also featured several presentations during [Meetup Workshops](https://www.youtube.com/watch?v=M_8x8iPpRVg&t=17s) and events like [RareEvo 2026](https://rareevo.io/) where they continue their ongoing collaboration with GoDaddy.  

In general, most Hiero projects still show a great dependency on Hashgraph, but compared to 2025, the diversity can be noticed more as the project continues to [gain popularity](https://insights.linuxfoundation.org/project/hiero/popularity?widget=forks).

<img width="1509" height="532" alt="image" src="https://github.com/user-attachments/assets/cd10e070-71aa-4f7d-822a-86fb97e210ec" />

When it comes to the Hiero community as a whole (maintainers, contributors, collaborators), LFX insights reflects a diversity increase compared to 2025. In this time frame, the dependency in a single organization remained close to 50% given the nature of the origin in Hiero's core components but added the additional diversity through the new sub projects acquired over time. 
<img width="711" height="617" alt="image" src="https://github.com/user-attachments/assets/b0f523e9-6dcd-4d7c-9d0c-43ca8a60fc33" />
<img width="711" height="617" alt="image" src="https://github.com/user-attachments/assets/2547356b-5fde-4dc9-b30d-cc40fdc2f70c" />
...
Hiero's 2026 main goals are centered on continue project promotion in an effort to gain more attention and invite more contributors to be part of our cause. 

From those goals, is worth presenting the following comparison:

|         Goal         |                                                                                                                                                                                                                       2025 Result                                                                                                                                                                                                                      | 2026 Work in Progress                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
|----------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Project Health       | Hiero's hiero-hackers organization has been created with the purpose of attracting and welcoming new ideas and jumpstart new contributors with an easy way for them to test new features and experiment with Hiero. Several of these ideas will be welcomed as project proposals in hiero-ledger. The project is focusing on gaining new talent and continue to build new maintainers via issue progression.                                           | Additional guidelines are being discussed internally to prepare for the project proposals that originate from hiero-hackers. The Hiero team is also excited for the results of the mentorship programs and the adoption of new improvement proposals. With the continuous development of Hiero Analytics, we are able to track project health more reliably and in better detail than before including HIP implementation across services and SDKs and OpenSSF scoring and best practices.                                                                                                                                                                                                                                                                                                        | 
| Maintainer Diversity | Maintainer Diversity was still very heavy on Hashgraph and Limechain ownership. With the adoption of new projects, the diversity started to become more evident.                                                                                                                                                                                                                                                                                       | In LFX Insights,Hiero's Project Health has a warning on organization diversity. However, compared to the previous term, we can see that the project grew more members and adoption that can be reflected in the charts discussed in the Maintainer Diversity section. The Hiero team is looking forward for 2026 elections which will gather new adopters and welcome a more diverse TSC team.                                                                                                                                                                                                                                                                                                                                                                                                    |
| Project Promotion    | Initially, Hiero presentations used to be featured as part of Hedera's event for the majority of them. In 2026, more presentations happened with Hiero being the center of attention.                                                                                                                                                                                                                                                                  | [Hiero's first official Community Day](https://hiero.org/blog/hiero-community-day-launched-2026) launched in July celebrating the project's achievements and discussing technical presentations alongside members from Hashgraph, OpenElements, BlockyDevs, Linux Foundation Decentralized Trust, DSR and independent community members. The project has also participated for the first time on mentoring new contributors via four exciting [Mentorship programs](https://hiero.org/blog/hiero-mentorship-2026). Additionally, the project has hosted several workshops (as mentioned above) and presentations at RareEvo, WomenWhoCode and several universities. All of these are examples of the progress and visibility the project is gaining compared to the previous term.                |
                                                                                                                      | In 2026, the project will maintain verified references, architecture diagrams, and user quotes to contribute to the meaningful content of our adopters information. We are also committed to work on user case research and case studies that can feature Hiero in recent news. The team continues the progress on project promotion in Hiero and LFDT events with participation in mentorship programs and workshops to invite new community members to be part of our development.                                                                                     | 
