---
layout: default
title: 2026 Annual Review Web3j
parent: 2026
...
The project has almost two years since it became part of the LF Decentralized Trust Ecosystem. It was migrated to Hyperledger Foundation from Web3 Labs organization at the beginning of 2024.
Over the past year, we have seen several new contributors and the similar evidence of Web3j usage by other companies, as in 2024, with one new company, Noise.xyz. 
...
The project delivered 3 releases in 2025, [Releases](https://github.com/LFDT-web3j/web3j/releases):
...
The project delivered 2 releases in 2025, [Releases](https://github.com/LFDT-web3j/web3j-evm/releases):
...
The project delivered 3 releases in 2025, [Releases](https://github.com/LFDT-web3j/web3j-unit/releases):
...
The project delivered 1 release in 2025, [Releases](https://github.com/LFDT-web3j/web3j-sokt/releases):

- v0.5.0 - April 9, 2025

### web3j-solidity-gradle-plugin

The project delivered 1 release in 2025, [Releases](https://github.com/LFDT-web3j/web3j-solidity-gradle-plugin/releases):

- v0.6.0 - April 9, 2025

### web3j-gradle-plugin

The project delivered 2 releases in 2025, [Releases](https://github.com/LFDT-web3j/web3j-gradle-plugin/releases):
...
The project delivered 2 releases in 2025, [Releases](https://github.com/LFDT-web3j/web3j-maven-plugin/releases):
...
The project delivered 2 releases in 2025, [Releases](https://github.com/LFDT-web3j/web3j-cli/releases):
...
One virtual events was held in order to promote the project and get more maintainers:
...
Based on the research conducted on the enterprise users of Web3j there are at least 13 organizations which are using Web3j for production use cases.
...
During the last year, the project has achieved the following goals:
- Continue to provide maintenance, resolve issues;
