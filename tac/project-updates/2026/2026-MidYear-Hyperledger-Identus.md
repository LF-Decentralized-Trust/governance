...
| Complete OpenSSF Best Practices and Scorecard adoption | **On track** | Scorecard workflows and Best Practices badges now cover many core repositories. The remaining work is visible on the [OpenSSF status page](https://ssf.identus.work/) and is planned for completion by the end of 2026. |
...
6. **Finish OpenSSF rollout by the end of 2026.** Extend Scorecard and Best Practices coverage to all actively maintained repositories and resolve the remaining priority findings tracked on the [OpenSSF status page](https://ssf.identus.work/).
