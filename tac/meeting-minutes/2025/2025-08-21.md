...
- Hyperledger Caliper (due August 28, 2025)
...
- [Hiero graduation request](https://github.com/LF-Decentralized-Trust/project-proposals/pull/30)
    - Approved by roll call vote (6 yes, Enrique had to drop before vote)
- [Defining Adopters](https://github.com/LF-Decentralized-Trust/governance/pull/164) (moved to next week)
- Lab Stewards discussion (email vote, Arun motion, Rama seconded)
